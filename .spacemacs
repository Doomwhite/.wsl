...
before packages are loaded."
  (defun set-scroll-margin-dynamically ()
    (interactive)
    (setq scroll-margin (truncate (* (window-height) 0.2))))

  (add-hook 'window-configuration-change-hook #'set-scroll-margin-dynamically)
)
